...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        whileInView={{opacity:1, y:0}}
        transition={{duration:0.5,delay:1 , ease:'ease-out'}}
        viewport={{once:true}}
        className='text-sm sm:text-lg font-medium text-gray-500 dark:white-text/75 max-w-4/5 sm:max-w-lg pb-3 dark:text-white/90'>Creating meaningful connections and turning big ideas into interactive digital experience</motion.p>
