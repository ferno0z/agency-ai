...
const Navbar = ({theme, setTheme}) => {
    ...
    sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <a href="#contact-us" className='text-sm max-sm:hidden flex items-center gap-2 bg-primary text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>Connect <img src={assets.arrow_icon} width={14} alt=''></img></a>
      </div>
